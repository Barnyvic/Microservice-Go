...
# Setup script for Product Microservice
...
echo "Running tests..."
go test -v ./... || {
    echo "⚠️  Some tests failed. This might be expected if the database is not set up."
}
echo ""
...
if command -v grpcurl &> /dev/null; then
    ...
    echo "⚠️  grpcurl is not installed (optional)"
